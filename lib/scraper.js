    ...
    let result = [];
        ...
        validatedMovies.forEach(function(movie) {
            ...
            if(movie.movie === '01') {
                switch (movie.day) {
                    case '05':
                        result.push('You guys can have your big day out on friday, you will see the movie "The Flying Deuces" at '
                            + movie.time + ' and your dinner starts at ' + (parseInt(movie.time) + 2) + ':00')
                        break;
                    case '06':
                        result.push('You guys can have your big day out on saturday, you will see the movie "The Flying Deuces" at '
                            + movie.time + ' and your dinner starts at ' + (parseInt(movie.time) + 2) + ':00')
                        break;
                    case '07':
                        result.push('You guys can have your big day out on sunday, you will see the movie "The Flying Deuces" at '
                            + movie.time + ' and your dinner starts at ' + (parseInt(movie.time) + 2) + ':00')
                        break;
                }
            }
            if(movie.movie === '02') {
                switch (movie.day) {
                    case '05':
                        result.push('You guys can have your big day out on friday, you will see the movie "Keep Your Seats, Please" at '
                            + movie.time + ' and your dinner starts at ' + (parseInt(movie.time) + 2) + ':00')
                        break;
                    case '06':
                        result.push('You guys can have your big day out on saturday, you will see the movie "Keep Your Seats, Please" at '
                            + movie.time + ' and your dinner starts at ' + (parseInt(movie.time) + 2) + ':00')
                        break;
                    case '07':
                        result.push('You guys can have your big day out on sunday, you will see the movie "Keep Your Seats, Please" at '
                            + movie.time + ' and your dinner starts at ' + (parseInt(movie.time) + 2) + ':00')
                        break;
                }
            }
            if(movie.movie === '03') {
                switch (movie.day) {
                    case '05':
                        result.push('You guys can have your big day out on friday, you will see the movie "A Day at the Races" at '
                            + movie.time + ' and your dinner starts at ' + (parseInt(movie.time) + 2) + ':00')
                        break;
                    case '06':
                        result.push('You guys can have your big day out on saturday, you will see the movie "A Day at the Races" at '
                            + movie.time + ' and your dinner starts at ' + (parseInt(movie.time) + 2) + ':00')
                        break;
                    case '07':
                        result.push('You guys can have your big day out on sunday, you will see the movie "A Day at the Races" at '
                            + movie.time + ' and your dinner starts at ' + (parseInt(movie.time) + 2) + ':00')
                        break;
                }
            }
